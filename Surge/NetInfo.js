 ...
 // 𝐅𝐫𝐨𝐦：https://github.com/Nebulosa-Cat/Surge/blob/main/Panel/Network-Info/test-version/networkCheck_test.js
 // https://github.com/Rabbit-Spec/Surge/blob/main/JS/Network-Info.js
 // 𝐔𝐩𝐝𝐚𝐭𝐞：2022.06.09 09:00
    ...
    if ($network['cellular-data']) {
      ...
      if (carrierId && radio) {
        cellularInfo = carrierNames[carrierId] ?
          ...
          '移动网络 | ' + radioGeneration[radio] + ' - ' + radio;
      }
    }
