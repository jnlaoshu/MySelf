...
脚本作者: @NobyDa 
脚本兼容: Surge、QuantumultX、Loon(2.1.20 413+)
主要功能：
...
*********************************
Surge模块地址：
https://raw.githubusercontent.com/jnlaoshu/MySelf/main/Surge/TestFlightAccount.sgmodule

*********************************
Stash 添加脚本：
*********************************
Stash覆写引用地址：
https://raw.githubusercontent.com/jnlaoshu/MySelf/main/Stash/Script/TestFlightAccount.stoverride

*********************************
Loon 添加脚本：
*********************************
Loon插件地址：
https://raw.githubusercontent.com/jnlaoshu/MySelf/main/Loon/TestFlightAccount.plugin

*********************************
QuantumultX 添加脚本：
*********************************
QuantumultX重写引用地址：
https://raw.githubusercontent.com/jnlaoshu/MySelf/main/Script/TestFlightAccount.js
注：以上引用地址需要打开并使用KOP-XIAO资源解析器，如没有解析器请使用脚本配置：
[rewrite_local]
^https:\/\/testflight\.apple\.com\/v\d\/(app|account|invite)s\/ url script-analyze-echo-response https://raw.githubusercontent.com/jnlaoshu/MySelf/main/Script/TestFlightAccount.js
[mitm]
