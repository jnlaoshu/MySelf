...
export default async function(ctx) {
  ...
  // 🎨 UI 渲染区域：【应用高级排版层级、边距、字重】
  return {
    type: 'widget', padding: 18, backgroundGradient: { type: 'linear', colors: BG_COLORS, startPoint: { x: 0, y: 0 }, endPoint: { x: 1, y: 1 } },
    children: [
