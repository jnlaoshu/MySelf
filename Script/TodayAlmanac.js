...
(async () => {
  ...
  // 恢复双行标题轮播
  const line1 = `${curYear}年${curMonth}月${curDay}日 星期${"日一二三四五六"[now.getDay()]} ${lNow.animal}年`;
  const line2 = `${lNow.monthCn}${lNow.dayCn} ${lNow.gzYear}年 ${getAstro(curMonth, curDay)}`;
