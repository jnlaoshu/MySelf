 ...
 * 更新：2026.01.16 按需求定制版 - 删除天干地支+固定标题+显示农历生肖年
 */
(async () => {
  /* ========== 常量配置 & 环境初始化 ========== */
  ...
  // 核心替换：生成【农历(生肖)年】信息，替代原天干地支行
  const lunarHeader = `${lunarNow.lYear}(${lunarNow.animal})年 ${lunarNow.monthCn}${lunarNow.dayCn} ${lunarNow.term || ''}`.trim();
