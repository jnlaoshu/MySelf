/*
 * 今日黄历&节假日倒数（V20.0 经典布局复刻版）
 * ✅ 布局：严格遵照第一版，分4行显示 [法定, 节气, 民俗, 国际]
 * ✅ 修复：保留 V19 的智能排序逻辑，解决显示错乱/空白问题
 * ✅ 兼容：保留 V17 的鹰眼匹配逻辑，确保宜忌数据准确
 */
(async () => {
  // ========== 1. 基础环境 (强制北京时间) ==========
